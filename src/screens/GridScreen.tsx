...
// Tela 5 - Quadro de dupla entrada 3x3
      ...
      <DndContext sensors={sensors} onDragEnd={onDragEnd}>
        <div style={{
          ...
          <div style={{
            ...
            gap: 6, background: "rgba(255,255,255,0.85)", padding: 10, borderRadius: 16,
...
function Cell({ id, filled, allCombos }: {
  ...
  return (
    <div ref={setNodeRef} style={{
      background: filled ? "#ecfdf5"
        : isOver ? (isExpected ? "rgba(34,197,94,0.2)" : "rgba(239,68,68,0.15)")
        : "white",
